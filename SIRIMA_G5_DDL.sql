...
CREATE TABLE JADWAL_PENTING (
	...
	FOREIGN KEY (nomor) REFERENCES PERIODE_PENERIMAAN(nomor) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (tahun) REFERENCES PERIODE_PENERIMAAN(tahun) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE PENERIMAAN_PRODI (
	...
	FOREIGN KEY (nomor_periode) REFERENCES PERIODE_PENERIMAAN(nomor_periode) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (tahun_periode) REFERENCES PERIODE_PENERIMAAN(tahun_periode) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE PENDAFTARAN (
	...
	FOREIGN KEY (nomor_periode) REFERENCES PERIODE_PENERIMAAN(nomor) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (tahun_periode) REFERENCES PERIODE_PENERIMAAN(tahun) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE LOKASI_UJIAN (
	...
	FOREIGN KEY (nomor_periode, tahun_periode, jenjang, waktu_awal) REFERENCES JADWAL_PENTING(nomor_periode, tahun_periode, jenjang, waktu_awal) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE PENDAFTARAN_SEMAS (
	...
	PRIMARY KEY (id_pendaftaran),
	FOREIGN KEY (id_pendaftaran) REFERENCES PENDAFTARAN(id) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (lokasi_kota, lokasi_tempat) REFERENCES LOKASI_UJIAN(lokasi_kota, lokasi_tempat) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE PENDAFTARAN_SEMAS_PASCASARJANA (
	...
	prodi_terakhir VARCHAR(10) NOT NULL,
...
CREATE TABLE RUANG_UJIAN (
	kota SERIAL NOT NULL,
	tempat TIMESTAMP NOT NULL,
...
CREATE TABLE PENGAWAS (
	...
	FOREIGN KEY (lokasi_kota, lokasi_tempat, lokasi_id) REFERENCES RUANG_UJIAN(lokasi_kota, lokasi_tempat, lokasi_id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE PENDAFTARAN_PRODI (
	...
	FOREIGN KEY (id_pendaftaran) REFERENCES PENDAFTARAN(kode_prodi) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (kode_prodi) REFERENCES PROGRAM_STUDI(kode) ON UPDATE CASCADE ON DELETE CASCADE
);